...
├── guide/                       # Обучающие модули
│   ├── README.md               # Обзор руководства
...
└── assets/                      # Медиафайлы
    ├── README.md               # Описание медиафайлов
    ├── images/                 # Изображения
...
### 🎓 Модули обучения
- **[Модуль 1: Основы и установка](guide/module-01/README.md)** ✅ Завершен
- [Модуль 2: Типы контента](guide/module-02/README.md) 📋 В разработке
- [Модуль 3: Пользователи и права](guide/module-03/README.md) 📋 В разработке
- [Модуль 4: API и интеграции](guide/module-04/README.md) 📋 В разработке
- [Модуль 5: Медиа и файлы](guide/module-05/README.md) 📋 В разработке
- [Модуль 6: Плагины](guide/module-06/README.md) 📋 В разработке
- [Модуль 7: Конфигурация](guide/module-07/README.md) 📋 В разработке
- [Модуль 8: Безопасность](guide/module-08/README.md) 📋 В разработке
- [Модуль 9: Развертывание](guide/module-09/README.md) 📋 В разработке
- [Модуль 10: Развитие проекта](guide/module-10/README.md) 📋 В разработке
- [Модуль 11: Продвинутые темы](guide/module-11/README.md) 📋 В разработке

### 📖 Приложения
- [Приложения](appendices/README.md) - Дополнительные материалы

### 🖼️ Медиафайлы
- [Медиафайлы](assets/README.md) - Изображения, видео, документы
...
Мы приветствуем обратную связь и активное участие сообщества! Если у вас есть вопросы, предложения или вы нашли ошибку, создайте Issue на GitHub:

### 📝 Типы Issues, которые мы принимаем:

#### 🐛 **Bug Reports (Сообщения об ошибках)**
- Неточности в документации
- Неправильные команды или примеры кода
- Проблемы с навигацией или ссылками
- Ошибки в переводах или формулировках

#### 💡 **Feature Requests (Предложения по улучшению)**
- Новые темы для изучения
- Дополнительные примеры и практические задания
- Улучшения структуры или навигации
- Новые разделы или модули

#### ❓ **Questions (Вопросы)**
- Затруднения в понимании материала
- Проблемы с выполнением практических заданий
- Технические вопросы по Strapi
- Запросы на разъяснение концепций

#### 📚 **Documentation Improvements (Улучшения документации)**
- Более подробные объяснения
- Дополнительные скриншоты или диаграммы
- Улучшения в структуре уроков
- Расширение FAQ и глоссария

### 🎯 Как создать качественный Issue:

1. **Используйте соответствующие шаблоны** - GitHub автоматически предложит шаблоны для разных типов Issues
2. **Опишите проблему подробно** - Включите контекст, шаги для воспроизведения, ожидаемый результат
3. **Укажите версии** - Strapi, Node.js, операционная система
4. **Приложите скриншоты** - Если это поможет лучше понять проблему
5. **Будьте вежливы** - Мы ценим конструктивную обратную связь

### 🚀 Как помочь проекту:

- **Создавайте Issues** для найденных проблем
- **Отвечайте на вопросы** других пользователей
- **Предлагайте улучшения** через Feature Requests
- **Делитесь опытом** в комментариях к Issues
...
*Примечание: GitHub Issues является предпочтительным способом связи для отслеживания и решения проблем.*
